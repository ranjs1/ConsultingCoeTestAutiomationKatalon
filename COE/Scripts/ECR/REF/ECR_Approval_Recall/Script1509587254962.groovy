...
while (GlobalVariable.WOSTATUS.contains('Pending')) {
    for (int j = 0; j < GlobalVariable.AssignmentList.size(); j++) {
        ...
        if (GlobalVariable.Status == 'Pending-RDApproval') {
            ...
            if (GlobalVariable.RDD_Recall == false) {
                ...
                GlobalVariable.RDD_Recall = false
            ...
            if (GlobalVariable.OpsRecall == false) {
                ...
                CustomKeywords.'com.helper.commonfunct.utilities.gsOpsRecall'()
            ...
            if (GlobalVariable.EXP_SVC_Recall == false) {
                ...
                GlobalVariable.EXP_SVC_Recall = false
